...
extern int msdc_partread_rwaccess(int partno, uint64_t offset, uint64_t size, void *pvmem);
extern int msdc_partwrite_rwaccess(int partno, uint64_t offset, uint64_t size, void *pvmem);
