 ...
 */
#ifdef CONFIG_EMMC_HS200_SUPPORT
...
#define MSDC_CLK_TARGET   162000000, 144000000, 120000000, 100000000, 80000000, 50000000, 50000000, 25000000, 12000000,  0
...
#define MSDC_CLK_TARGET   162000000, 144000000, 108000000, 100000000, 80000000, 50000000, 50000000, 25000000, 12000000,  0
#define MSDC_CLK_SRC_VAL    4,   5,   7,  11,  9,  8, 11, 11,  0,  0
#define MSDC_CLK_MODE_VAL   1,   1,   1,   0,  1,  1,  2,  0,  0,  0
#define MSDC_CLK_DIV_VAL    0,   0,   0,   0,  0,  0,  0,  2,  0, 16
#define MSDC_CLK_DRV_VAL   	2,   2,   2,   2,  2,  2,  2,  2,  2,  0
#define MSDC_CMD_DRV_VAL   	5,   5,   5,   5,  5,  5,  5,  5,  5,  0
#define MSDC_DAT_DRV_VAL   	5,   5,   5,   5,  5,  5,  5,  5,  5,  0
#define MSDC_CLK_SAMP_VAL 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x0, 0x0, 0x0, 0x0
#endif
...
#endif
#else
#if defined(CONFIG_EMMC_DDR50_SUPPORT)
...
#define msdc_is_highmem(addr)	((addr) > high_memory)
