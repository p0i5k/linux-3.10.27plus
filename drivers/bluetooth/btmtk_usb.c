...
static void btmtk_usb_set_state(int new_state)
{
    printk("%s : %s(%d) -> %s(%d)\n", __FUNCTION__,
            ...
            btmtk_usb_state==BTMTK_USB_STATE_SUSPEND_ERROR_DISCONNECT?"SUSPEND_ERROR_DISCONNECT":
            btmtk_usb_state==BTMTK_USB_STATE_SUSPEND_ERROR_PROBE?"SUSPEND_ERROR_PROBE":
            btmtk_usb_state==BTMTK_USB_STATE_SUSPEND_ERROR_FW_DUMP?"SUSPEND_ERROR_FW_DUMP":
            btmtk_usb_state==BTMTK_USB_STATE_RESUME_ERROR_DISCONNECT?"RESUME_ERROR_DISCONNECT":
            btmtk_usb_state==BTMTK_USB_STATE_RESUME_ERROR_PROBE?"RESUME_ERROR_PROBE":
            btmtk_usb_state==BTMTK_USB_STATE_RESUME_ERROR_FW_DUMP?"RESUME_ERROR_FW_DUMP":"UNKNOWN",
            btmtk_usb_state,
            ...
            new_state==BTMTK_USB_STATE_SUSPEND_ERROR_DISCONNECT?"SUSPEND_ERROR_DISCONNECT":
            new_state==BTMTK_USB_STATE_SUSPEND_ERROR_PROBE?"SUSPEND_ERROR_PROBE":
            new_state==BTMTK_USB_STATE_SUSPEND_ERROR_FW_DUMP?"SUSPEND_ERROR_FW_DUMP":
            new_state==BTMTK_USB_STATE_RESUME_ERROR_DISCONNECT?"RESUME_ERROR_DISCONNECT":
            new_state==BTMTK_USB_STATE_RESUME_ERROR_PROBE?"RESUME_ERROR_PROBE":
            new_state==BTMTK_USB_STATE_RESUME_ERROR_FW_DUMP?"RESUME_ERROR_FW_DUMP":"UNKNOWN",
            new_state);
...
static void btmtk_usb_late_resume(void)
{
              ...
              btmtk_usb_get_state() == BTMTK_USB_STATE_RESUME_ERROR_FW_DUMP )
    {
        ...
        return;
              ...
              btmtk_usb_get_state() != BTMTK_USB_STATE_SUSPEND )
    {
        printk("%s previous state is not suspend/resume(%d), ignore.\n", __FUNCTION__, btmtk_usb_get_state());
        return;
    }
