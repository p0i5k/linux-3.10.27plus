...
#define BT_DONGLE_RESET_GPIO_PIN 243
/* SYS Control */
...
#define BT_SEND_HCI_CMD_BEFORE_STANDBY 0
...
#define SAVE_FW_DUMP_IN_KERNEL 0/*only control save file in kernel or not*/
#define SET_TX_POWER_AFTER_ROM_PATCH	0/*after rom patch,  set power*/
...
#define SUPPORT_MT6632 0
#define SUPPORT_MT7637 0
