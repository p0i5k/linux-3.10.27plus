...
void _U3_Write_Bank(int bankValue){
	...
	case U3_PHY_PG_U2PHY:
		u4PhyBankOffset =(int) U3_PHY_PG_U2PHY_OFFSET;
		break;
        case U3_PHY_PG_PHYD:
            u4PhyBankOffset = (int)U3_PHY_PG_PHYD_OFFSET;
            break;
        case U3_PHY_PG_PHYD2:
            u4PhyBankOffset = (int)U3_PHY_PG_PHYD2_OFFSET;
            break;
        case U3_PHY_PG_PHYA:
            u4PhyBankOffset = (int)U3_PHY_PG_PHYA_OFFSET;
            break;
        case U3_PHY_PG_PHYA_DA:
            u4PhyBankOffset = (int)U3_PHY_PG_PHYA_DA_OFFSET;
            break;
        case U3_PHY_PG_SPLLC:
            u4PhyBankOffset = (int)U3_PHY_PG_SPLLC_OFFSET;
            break;
        case U3_PHY_PG_FM:
            u4PhyBankOffset = (int)U3_PHY_PG_FM_OFFSET;
            break;
        default:
            break;
    }
