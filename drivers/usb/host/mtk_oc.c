...
#define OC_USB3_2_PORT_STA_BASE 0xF0074430
#define OC_USB3_3_PORT_STA_BASE 0xF0074420
    ...
    if(u1Is4K)          // 4K model
        ...
        if(id == 1 || id == 2)
            ...
            *buf = pController->pThis->bInsert;
            ...
            {
            U3_InsertSTA = MGC_Read32(OC_USB3_2_PORT_STA_BASE, OC_USB3_PORT_STA_OFST);
			U3_InsertSTA |= MGC_Read32(OC_USB3_3_PORT_STA_BASE, OC_USB3_PORT_STA_OFST);
            U3_InsertSTA &= 0x1;
            *buf = U3_InsertSTA;
        }
    }
