...
#define MGC_ReadQMU32(base,_offset) \
    *((volatile uint32_t *)(((uint32_t)base) + (USB_HW_QMU_OFF)+ (_offset)))

#define MGC_ReadQUCS32(base,_offset) \
    *((volatile uint32_t *)(((uint32_t)base) + (USB_HW_QUCS_OFF)+ (_offset)))

#define MGC_ReadQIRQ32(base,_offset) \
    *((volatile uint32_t *)(((uint32_t)base) + (USB_HW_QIRQ_OFF)+ (_offset)))
...
#define MGC_WriteQMU32(base,_offset, _data) \
    (*((volatile uint32_t *)(((uint32_t)base) + (USB_HW_QMU_OFF)+ (_offset))) = _data)

#define MGC_WriteQUCS32(base,_offset, _data) \
    (*((volatile uint32_t *)(((uint32_t)base) + (USB_HW_QUCS_OFF)+ (_offset))) = _data)

#define MGC_WriteQIRQ32(base,_offset, _data) \
    (*((volatile uint32_t *)(((uint32_t)base) + (USB_HW_QIRQ_OFF)+ (_offset))) = _data)
