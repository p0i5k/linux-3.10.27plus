...
int MUC_ResetPhy_Musb(void *pBase)
{
	...
	*pu4MemTmp = 0x00cfff00;
	...
	u4Reg = MGC_PHY_Read32(pBase,(uint32_t)0x00); //RG_USB20_USBPLL_FORCE_ON=1b
	u4Reg |=   0x00008000; 
	...
	u4Reg = MGC_PHY_Read32(pBase,(uint32_t)0x1C);
	u4Reg |=  0x01000000; 
	MGC_PHY_Write32(pBase, (uint32_t)0x1C, u4Reg);
...
#if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891)
	u4Reg = MGC_PHY_Read32(pBase, (uint32_t)0x14); //bit[14:12]
	if(IS_IC_MT5890_ES1())
	{
