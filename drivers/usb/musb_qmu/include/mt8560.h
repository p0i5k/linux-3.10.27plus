...
#define MGC_PHY_Read32(_pBase, r)      \
(\
	((uint32_t)_pBase ==(uint32_t) (MUSB_BASE))?\
	*((volatile uint32_t *)( (MUSB_PORT0_PHYBASE) + (r))):\
	(((uint32_t)_pBase == (uint32_t)(MUSB_BASE1))?\
	*((volatile uint32_t *)( (MUSB_PORT1_PHYBASE) + (r))):\
	(((uint32_t)_pBase == (uint32_t)(MUSB_BASE3))?\
...
#define MGC_PHY_Write32(_pBase, r, v)\
{ \
	if((uint32_t)_pBase == (uint32_t)(MUSB_BASE)){ \
    printk("USB PHY Port 0\n");\
    *((volatile uint32_t *)((MUSB_PORT0_PHYBASE) + (r))) = v;\
    printk("USB PHY@0x%08X = 0x%08X\n", ((uint32_t)((MUSB_PORT0_PHYBASE) + (r))), (uint32_t)v);\
    }\
    else if((uint32_t)_pBase == (uint32_t)(MUSB_BASE1)){\
    printk("USB PHY Port 1\n");\
    *((volatile uint32_t *)( (MUSB_PORT1_PHYBASE) + (r))) = v;\
    printk("USB PHY@0x%08X = 0x%08X\n", ((uint32_t)((MUSB_PORT1_PHYBASE) + (r))), (uint32_t)v);\
    }\
    else if((uint32_t)_pBase == (uint32_t)(MUSB_BASE3)){\
    printk("USB PHY Port 3\n");\
    *((volatile uint32_t *)( (MUSB_PORT3_PHYBASE) + (r))) = v;\
    printk("USB PHY@0x%08X = 0x%08X\n", ((uint32_t)((MUSB_PORT3_PHYBASE) + (r))), (uint32_t)v);\
    }\
	else if((uint32_t)_pBase ==(uint32_t) (MUSB_BASE2)){\
	printk("USB PHY Port 2\n");\
	*((volatile uint32_t *)( (MUSB_PORT2_PHYBASE) + (r))) = v;\
	printk("USB PHY@0x%08X = 0x%08X\n", ((uint32_t)((MUSB_PORT2_PHYBASE) + (r))), (uint32_t)v);\
    }\
}
#endif
...
if((uint32_t)_pBase == (uint32_t)MUSB_BASE || (uint32_t)_pBase == (uint32_t)MUSB_BASE1 || (uint32_t)_pBase == (uint32_t)MUSB_BASE2 || (uint32_t)_pBase == (uint32_t)MUSB_BASE3){\
...
if((uint32_t)_pBase == (uint32_t)MUSB_BASE || (uint32_t)_pBase == (uint32_t)MUSB_BASE2 || (uint32_t)_pBase == (uint32_t)MUSB_BASE3){\
if((MGC_O_HDRC_INTRTX != _offset)&&( MGC_O_HDRC_FADDR == ((_offset) & 0xFFFFFFFC)))\
u4TmpVar &= 0x0000FFFF;\
else if ((MGC_O_HDRC_INTRRX != _offset)&&(MGC_O_HDRC_INTRRX == ((_offset) & 0xFFFFFFFC)))\
u4TmpVar &= 0xFFFF0000;\
