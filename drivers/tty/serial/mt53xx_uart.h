...
/* uart 5 UART_BT*/
#define UART5_BASE              (0x180) // 0xc180 //(0x880)// 0x28880

#define UART5_DATA              (UART5_BASE + 0x000)
#define UART5_DATA_BYTE         (UART5_DATA + 0x000)

#define UART5_STATUS_OLD        (0x0 + 0x004)// 0xc004
    #define U5_TRANSPARENT (1 << 6)

#define UART5_INT_EN            (0x0 + 0x00c)// 0xc00C
    //#define U5_T8032D      (1 << 7)  // normal mode t8032 data
    //#define U5_RISCD       (1 << 6)  // normal mode risc data
    #define U5_OVRUN       (1 << 26)  // rxd buffer overflow r:23
    #define U5_OVRUN_R  (1 << 23)
	
    #define U5_MRIE       (1 << 25)  //  r:28
    #define U5_MRIE_R       (1 << 28)  //

    #define U5_TBUF        (1 << 24)  // txd buffer empty r:27
    #define U5_TBUF_R        (1 << 27)
	
    #define U5_TOUT        (1 << 23)  // rxd timeout r:26
    #define U5_TOUT_R        (1 << 26)
	
    #define U5_RBUF        (1 << 7)  // rxd data available r:25
    #define U5_RBUF_R        (1 << 25)
	 
    #define U5_RERR        (1 << 6)  // rxd error  r: 24
    #define U5_RERR_R        (1 << 24)

    #define U5_INTMSK      (U5_OVRUN | U5_MRIE | U5_TBUF | U5_TOUT | U5_RBUF | U5_RERR)
	#define U5_INTMSK_R      (U5_OVRUN_R | U5_MRIE_R | U5_TBUF_R | U5_TOUT_R | U5_RBUF_R | U5_RERR_R)
	#define U5_INTALL	   (U5_TOUT | U5_RBUF | U5_RERR)

#define UART5_INT_ID            (0x010)//(UART5_BASE + 0x010)
//#define UART5_RS232_MODE        (UART5_BASE + 0x018)
//#define UART5_BUFFER_SIZE       (UART5_BASE + 0x01c)
#define UART5_COMMCTRL          (UART5_BASE + 0x008)
#define UART5_STATUS            (UART5_BASE + 0x00c)
#define UART5_BUFCTRL           (UART5_BASE + 0x010)
#endif
