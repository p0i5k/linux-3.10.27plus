...
#define GPIO_SUPPORT_INT_NUM	95// GPIO0~GPIO55, SDIO, CI_DEMOD(7)
...
#define PDWNC_SRVCST 	(IO_PDWNC_BASE + 0x370)
#define PDWNC_ADOUT0 	(IO_PDWNC_BASE + 0x374)
